...
```
git clone https://github.com/gustavoerivero/Flymagine-backend.git
```

Next, go to the cloned folder in the "Flymagine-backend" repository.

For a Windows operating system, with the command:

```
cd Flymagine-backend
```
...
[Click here to go to the Flymagine frontend repository.](https://github.com/gustavoerivero/Flymagine-frontend)
